...
class RegisterForm(forms.Form):
    ...
    def clean_password2(self):
        ...
        if len(password1) <= 6:
            raise forms.ValidationError("Password has to be longer than 6 characters")
...
class UserChangeForm(forms.ModelForm):
    ...
    class Meta:
        model = MyUser
        fields = ('email', 'password', 'username', 'first_name', 'last_name', 'is_member','is_active', 'is_admin')
