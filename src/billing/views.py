...
def cancel_subscription(request):
		...
		if sub_id:
				...
				if result.is_success:
						...
						messages.error(request, "There as an error with your account, please contact us.")
		else:
